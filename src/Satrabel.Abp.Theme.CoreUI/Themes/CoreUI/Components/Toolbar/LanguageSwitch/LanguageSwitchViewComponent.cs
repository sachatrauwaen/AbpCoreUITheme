...
namespace Satrabel.Abp.Theme.CoreUI.Themes.CoreUI.Components.Toolbar.LanguageSwitch
{
    public class LanguageSwitchViewComponent : AbpViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Themes/CoreUI/Components/Toolbar/LanguageSwitch/Default.cshtml", model);
        }
    }
}
